                            ...
                            <div class="contact-form-wrapper">
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="section-tittle mb-50">
                                            ...
                                            <p>Para la compra de tiquetes es necesario que esté registrado en nuestra aplicación</p>
                                        </div>
                                </div>
                                </div>
                                <!-- form -->
                                        ...
                                        <div class="col-lg-6">
                                            <div class="select-items">
                                                <select name="select" id="select1">                                                
                                                    ...
                                                    <option value="Panameño">Panamá</option>
                                                    ...
                                                    <option value="Beliceño">Belice</option>
                                                </select>
                                            </div>
                                        </div>                                     
                                        <div class="col-lg-6 col-md-6">
