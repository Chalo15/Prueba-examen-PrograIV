...
<head>
  ...
  <!-- CSS here aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa asdadasd-->
    <!-- CSS here -->
...
<main>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9">
                            <div class="hero__caption">
                                <h1 >Buses <span>San Marino<br></span> ¡A su servicio!</h1>
                            </div>
                            <div class="hero-pera">
                                <p>Trabajando para todo Centro America</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-info mb-30">
                        ...
                        <div class="info-caption">
                            <p>Centro America</p>
                            <span>Costa Rica, Alajuela - 20101</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-caption mb-50">
                        ...
                        <div class="section-tittle mb-35">
                            ...
                            <h2>La valiosa compañia de nuestros usuarios hacen que cada vez se valoren más nuestros dias!</h2>
                        </div>
                        <p>Somos una empresa familiar que nacio hace 40 años en Costa Rica. Hoy se encarga de ella la familia Marino-Boza (segunda generación desde la fundación), con más de 500 empleados a su cargo.</p>
                        <p>Nuestro objetivo es servirle a usted y su familia, hoy a nivel centroamericano, en la totalidad de sus tranportes en todo momento.</p>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-img ">
                        <div class="about-font-img">
                            <img src="assets/img/gallery/nosotros2.jpg" alt="">
                        </div>
    ...
    <!-- About Area End -->
    <!--? contact-form start -->
    <section class="contact-form-area section-bg  pt-115 pb-120 fix" data-background="assets/img/gallery/banner2.png">
        <div class="container">
