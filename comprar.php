...
session_destroy();
//header("Location: index.php");//cambiar direccion o hacer otra pag para que muestre esta info
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <span>Comodidad y Seguridad</span>
                            <h2>Nuestras Rutas Disponibles</h2>
                        </div>
